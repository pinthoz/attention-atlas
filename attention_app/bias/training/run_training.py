...
#   python attention_app/bias/training/run_training.py                     # fine-tune GUS-Net on new_dataset.json
#   python attention_app/bias/training/run_training.py --combine-datasets  # fine-tune on new_dataset + bias_annotations
#   python attention_app/bias/training/run_training.py --from-scratch      # train from bert-base-uncased (ablation)
#   python attention_app/bias/training/run_training.py --dataset path/to/data.json
