...
def server(input, output, session):
    ...
    # ── ISA handlers (extracted to isa_handlers.py) ────────────────────
    register_isa_handlers(
        input=input,
        output=output,
        get_active_result=get_active_result,
        generate_export_filename=generate_export_filename,
        isa_selected_pair=isa_selected_pair,
        isa_selected_pair_B=isa_selected_pair_B,
    )
    ...
    # ── Export handlers (extracted to export_handlers.py) ──────────────
    register_export_handlers(
        input=input,
        auto_save_download=auto_save_download,
        get_active_result=get_active_result,
        global_norm_mode=global_norm_mode,
        global_metrics_mode=global_metrics_mode,
        global_rollout_layers=global_rollout_layers,
        get_normalized_attention=get_normalized_attention,
    )
