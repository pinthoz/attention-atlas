...
def create_bias_accordion():
    ...
    def section_note(body: str):
        """Panel introduction with bottom accent line."""
        return ui.p(
            body,
            style=(
            ...
            ui.div(
                ...
                ui.tags.style("""
                    .ablation-pill {
                        ...
                        cursor: pointer; transition: all 0.2s ease; opacity: 0.75;
                    }
                    .ablation-pill:hover { opacity: 0.85; transform: translateY(-1px); }
                    .ablation-pill.active {
                        opacity: 1; border-color: var(--pill-color);
                        box-shadow: 0 0 12px color-mix(in srgb, var(--pill-color) 25%, transparent);
                    }
                    .ablation-pill-label {
                        font-family: 'JetBrains Mono', monospace; font-size: 11px;
                        font-weight: 700; color: var(--pill-color); line-height: 1;
                    }
                    .ablation-pill-sub {
